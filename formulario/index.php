...
<body>
    ...
    <form action="./" method="POST">
        ...
        <div class="contact-info">
            ...
            <div class="info">
                <span><i class="fas fa-map-marker-alt"></i> Zona Franca Santander, Zenith, Anillo Vial #piso 6, Bucaramanga, El Caucho, Floridablanca, Santander.</span>
            </div>

            <div class="info">
                <span><i class="fas fa-phone"></i> +57 311 8807659</span>
            </div>
